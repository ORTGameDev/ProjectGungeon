...
@:keep @:bind #if display private #end class __ASSET__img_atlas_spritemap_json extends null { }
...
@:keep @:bind #if display private #end class __ASSET__img_atlas_test_json extends null { }
