...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("GastonIgnacio", "Obligatorio", "Obligatorio", "1.0.0");
		...
		telemetryConfig.app_name = "Obligatorio";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Obligatorio", null, { width: 800, height: 480 });
