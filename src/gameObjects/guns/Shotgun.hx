	...
	public  override function shoot (aX:Float, aY:Float, aTargetX:Float, aTargetY:Float): Void
	{
		if(currentInChamber > 0){
			...
			if (currentTime> gunLastShoot + shootDelay){
				...
				bullet1.shootWithAngle(aX, aY, aTargetX, aTargetY, Math.PI / 32);
